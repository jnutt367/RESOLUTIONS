...
let wizardTalk = gsap.timeline()
    ...
    .fromTo("#h", { opacity: 0 }, { fill: "#e4196e", stroke: "#e4196e", opacity: 1 })
    .fromTo("#o", { opacity: 0 }, { opacity: 1 })
    .fromTo("#c", { opacity: 0 }, { fill: "#e4196e", opacity: 1 })
    .fromTo("#u", { opacity: 0 }, { opacity: 1 })
    .fromTo("#s", { opacity: 0 }, { fill: "#e4196e", opacity: 1 })
    .fromTo("#r", { opacity: 0 }, { opacity: 1 })
    .fromTo("#e", { opacity: 0 }, { fill: "#e4196e", opacity: 1 })
    .fromTo("#f", { opacity: 0 }, { opacity: 1 })
    .fromTo("#colon", { opacity: 0 }, { fill: "#e4196e", opacity: 1 })
    .fromTo("#second-o", { opacity: 0 }, { opacity: 1 })
    .fromTo("#c", { opacity: 0 }, { fill: "#e4196e", opacity: 1 })
    .fromTo("#u", { opacity: 0 }, { opacity: 1 })
    .fromTo("#s", { opacity: 0 }, { fill: "#e4196e", opacity: 1 })
    .fromTo("#exclaimation", { opacity: 0 }, { opacity: 1 })