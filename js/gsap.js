...
let wizardTalk = gsap.timeline()
    ...
    .fromTo("#h", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +8)
    .fromTo("#o", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +8)
    .fromTo("#c", { opacity: 0 }, { fill: "white", opacity: 1 }, +8)
    .fromTo("#u", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +8)
    .fromTo("#s", { opacity: 0 }, { fill: "white", opacity: 1 }, +8)
    .fromTo("#r", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +8.5)
    .fromTo("#e", { opacity: 0 }, { fill: "white", opacity: 1 }, +8.7)
    .fromTo("#f", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +8.9)
    .fromTo("#colon", { opacity: 0 }, { fill: "white", opacity: 1 }, +9.1)
    .fromTo("#second-o", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +9.3)
    .fromTo("#c2", { opacity: 0 }, { fill: "white", opacity: 1 }, +9.5)
    .fromTo("#u2", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1 }, +9.7)
    .fromTo("#s2", { opacity: 0 }, { fill: "white", opacity: 1 }, +9.9)
    .fromTo("#exclaimation", { opacity: 0 }, { fill: "white", stroke: "#e4196e", opacity: 1, y: -20, scale: 1.3, repeat: -1 }, +11)